...
{
    ms_tiles = new SDL_Surface*[TileSetLoader::TILE_LIST_SIZE];

    ms_tiles[TileSetLoader::TILE_CAVE] = IMG_Load("images/cave.png");
    ms_tiles[TileSetLoader::TILE_DIRT] = IMG_Load("images/dirt.png");
    ms_tiles[TileSetLoader::TILE_FOREST] = IMG_Load("images/forest.png");
    ms_tiles[TileSetLoader::TILE_GRASS] = IMG_Load("images/grass.png");
    ms_tiles[TileSetLoader::TILE_HILL] = IMG_Load("images/hills.png");
    ms_tiles[TileSetLoader::TILE_MOUNT] = IMG_Load("images/mount.png");
    ms_tiles[TileSetLoader::TILE_WATER] = IMG_Load("images/water.png");
    ms_tiles[TileSetLoader::TILE_PARTY] = IMG_Load("images/warrior.png");
    ms_tiles[TileSetLoader::TILE_NONE] = IMG_Load("images/none.png");
}

void TileDisplayZone::ms_computeTileMask()
{
    for (int i = 0; i < TileSetLoader::TILE_LIST_SIZE; i++)
    {
...
SDL_Rect TileDisplayZone::render(SDL_Surface* screen, TileSetLoader::TileSet const& tileSet) const
{
    ...
    for (TileSetLoader::TileSet::const_iterator yit = tileSet.cbegin(); tileSet.cend() != yit; ++yit)
    {
        tileNumHeight++;

        for (TileSetLoader::TileSetLine::const_iterator xit = yit->cbegin(); yit->cend() != xit; ++xit)
        {
            tileNumWidth++;
...
SDL_Rect TileDisplayZone::render(SDL_Surface* screen, Position tilePos, TileSetLoader::Tile tile) const
{
